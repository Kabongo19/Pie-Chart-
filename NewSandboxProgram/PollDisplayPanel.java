  ...
  private void drawPieChart(Graphics g, int x, int y, int r)
  {
    ...
    if (total > 0)
    {
      ...
      drawSector(g, x, y, r, fromDegree, degrees);
       ...
       fromDegree += degrees;
// need blocks for count2 and count3 make sure the slices are different colors
...
// convert values into a String (one of two methods to do that)
  ...
  private int countToDegrees(int count, int total)
  {
    ...
    return (int)Math.round(360.0 * count / total);
  }
